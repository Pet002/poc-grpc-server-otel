...
func (x *UserRes) Reset() {
	*x = UserRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_general_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserRes) Descriptor() ([]byte, []int) {
	return file_proto_general_proto_rawDescGZIP(), []int{1}
}

func (x *UserRes) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proto_general_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x1d, 0x0a, 0x07, 0x55,
	0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x23, 0x0a, 0x07, 0x55, 0x73,
	...
	0x38, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x28, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x0d, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x1a, 0x0d, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x61,
	0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_general_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_general_proto_goTypes = []any{
	(*UserReq)(nil), // 0: user.UserReq
	(*UserRes)(nil), // 1: user.UserRes
}
var file_proto_general_proto_depIdxs = []int32{
	0, // 0: user.HelloService.SayHello:input_type -> user.UserReq
	1, // 1: user.HelloService.SayHello:output_type -> user.UserRes
...
func file_proto_general_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_general_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_general_proto_msgTypes[1].Exporter = func(v any, i int) any {
